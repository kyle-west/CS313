<?php
   ...
   if (isset($_POST["submit"])) {
      ...
      $len = strlen($pass);
      if ($len < 8 || !preg_match("/[0-9]/", $pass)) {
         $err = "Passwords must be a minimum of 7 charaters and contain at least one number";
      } else if ($pass != $pass2) {
...
<html>
   ...
   <body onload="document.getElementById('usrn').focus();">
      ...
      <div class = "content">
         <form class="" action="temp.php" method="post" onsubmit="">
            <table class = "fillbox">
               <tr>
               ...
               <tr>
                  ...
                  <td class="right">
                     <input id = "pass_confirmed" type="password" name="passc" value=""
                            onblur = ""/>
                  </td>
               </tr>
               <tr>

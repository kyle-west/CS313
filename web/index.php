   ...
   <body>
      ...
      <div id = "main_container">
         ...
         <div class="block_content">
            <h1>Who are we?</h1>
            <p>
               The term <i>Lexifex</i> is derived from Latin and means "Builders of Code".
               Our aim is to innovate quality within the software design craftsmanship.
            </p>
         </div>
         <div class="block_content">
            <h1>What do we do?</h1>
            <p>
               Our team has but one specialty - passion. Passion drives our desire to
               design and create any software product our clients need. Whether that's
               Web, Desktop, or Mobile - we love the challenge that comes from creating
